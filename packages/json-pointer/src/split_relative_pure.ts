 ...
 * @group splitters
 */
export function split_relative_pure(pointer: RelativeOnlyPointer | RelativePurePointer): { relative: number, segments: Segment[] };
 ...
 * @group splitters
 */
export function split_relative_pure(pointer: string): { relative: number, segments: Segment[] };
